...
a three-panel plot that shows the 24-hour activity time courses for each education level and color to indicate sex. Describe in words any patterns or conclusions you can make based on this graph
```{r}
nhanes_merge |>
