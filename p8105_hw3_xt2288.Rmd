...
```
The total activity decreases as the age increases for both men and women. In less than high school education level, women has a higher total activity around age 32, and men has a higher activity around age 58. In the high school equivalent level, women has a higher total acitivity before age 50. After that age, men and women have the same trend. In more than high school level, men and women have about the same trend, except for age about 65 where female has a much higher total activity. 


Accelerometer data allows the inspection activity over the course of the day. Make a three-panel plot that shows the 24-hour activity time courses for each education level and use color to indicate sex. Describe in words any patterns or conclusions you can make based on this graph
```{r}
nhanes_merge |>
